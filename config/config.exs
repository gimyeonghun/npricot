...
config :npricot, NpricotWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: NpricotWeb.ErrorHTML, json: NpricotWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Npricot.PubSub,
  live_view: [signing_salt: "jRlmeGGH"]
...
config :npricot, Npricot.Mailer, adapter: Swoosh.Adapters.Local
